...
public class MovieRGraph {
   public void rGraph()
   {
	   try
	   {
		   ...
		   rc.voidEval("png(\"/home/sist/bigdataStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/MapReduceWebProject/movie/feel.png\",width=600,height=400)");
   ...
   public List<FeelVO> movieFeelData()
   {
